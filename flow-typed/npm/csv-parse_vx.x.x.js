// flow-typed signature: f4de31133ce2ed67d681c351f32c78fc
// flow-typed version: <<STUB>>/csv-parse_v5.3.4/flow_v0.142.0
...
declare module 'csv-parse' {
  ...
  declare export interface CastingContext {
  ...
  declare export type CastingFunction = (value: string, context: CastingContext) => any;
  declare export type CastingDateFunction = (
    value: string,
    context: CastingContext
  ) => Date;
  declare export type ColumnOption =
    | string
    | void
    | null
    | false
  ...
  declare export type CsvErrorCode =
  ...
  declare export class CsvError mixins Error {
    +code: CsvErrorCode;
    [key: string]: any;
    constructor(
      code: CsvErrorCode,
