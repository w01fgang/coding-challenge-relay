...
declare type $npm$firebase$auth$Error = {|
  +code:
    | 'auth/app-deleted'
...
declare type $npm$firebase$auth$UserCredential = {|
...
declare type $npm$firebase$Claims = { claims: { [key: string]: string } };
...
declare class $npm$firebase$auth$User extends $npm$firebase$auth$UserInfo {
  ...
  getIdTokenResult(forceRefresh?: boolean): Promise<$npm$firebase$Claims>;
