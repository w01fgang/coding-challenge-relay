...
// flow-typed version: 40038b550b/@sentry/node_v5.x.x/flow_>=v0.90.x
...
declare module '@sentry/nextjs' {
    ...
    // https://docs.sentry.io/platforms/javascript/troubleshooting/#events-with-non-error-exception
    declare export function captureException(Error, extraData?: mixed): void;
    ...
    declare export function withSentry(fn: mixed): mixed;
    ...
    declare export type ErrorBoundaryProps = {
       ...
       *
       */
      fallback?: React$ReactElement | $FlowFixMe,
    ...
    declare export class ErrorBoundary extends React$AbstractComponent<$FlowFixMe> {}
}
